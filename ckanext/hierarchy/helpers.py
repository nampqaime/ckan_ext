...
def group_tree(organizations=[], type_='group'):
...
def group_tree_section(id_, type_='group', include_parents=True,
...
def group_tree_parents(id_, type_='group'):
...
def group_tree_get_longname(id_, default="", type_='group'):
    tree_node = p.toolkit.get_action('organization_show')({}, {'id': id_})
